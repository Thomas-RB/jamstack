...
exports.Picture = react_1.forwardRef(function Picture(_a, ref) {
    ...
    var fallbackImage = (react_1["default"].createElement(Image, __assign({}, props, fallback, { shouldLoad: shouldLoad, innerRef: ref })));
    if (!sources.length) {
    ...
    return (react_1["default"].createElement("picture", null,
        sources.map(function (_a) {
            ...
            return (react_1["default"].createElement("source", { key: media + "-" + type + "-" + srcSet, type: type, media: media, srcSet: srcSet }));
        }),
        fallbackImage));
});
Image.propTypes = {
