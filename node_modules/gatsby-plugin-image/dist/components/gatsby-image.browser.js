...
exports.GatsbyImageHydrator = function GatsbyImageHydrator(_a) {
    ...
    return (react_1["default"].createElement(Type, __assign({}, wrapperProps, { style: __assign(__assign(__assign({}, wStyle), style), { backgroundColor: backgroundColor }), className: "" + wClass + (className ? " " + className : ""), ref: root, dangerouslySetInnerHTML: { __html: "" }, suppressHydrationWarning: true })));
};
